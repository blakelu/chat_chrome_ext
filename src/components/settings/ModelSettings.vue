  ...
  <div class="model-settings">
    ...
    <div class="tags-container">
      <div class="tags-wrapper" ref="tagsContainer">
        <div v-for="tag in modelList" :key="tag" class="tag-item">
          <span class="tag-text">{{ tag }}</span>
          <el-button class="tag-close" circle plain size="small" @click="handleDelete(tag)">
      ...
      <div class="tags-actions">
        <el-button class="add-btn" type="primary" plain @click="showInput" v-if="!inputVisible">
          <el-icon></el-icon>
          添加模型
        </el-button>

        <el-button class="restore-btn" @click="restoreDefaults" :disabled="restoreDisabled">
          <el-icon></el-icon>
          恢复默认
        </el-button>
      </div>
