<template>
  ...
  >
    ...
    <div class="share-actions">
      <el-button type="primary" size="default" @click="copyShareImage" :loading="generating">
        复制图片
      </el-button>
      <el-button type="success" size="default" @click="downloadShareImage" :loading="generating">
        下载图片
      </el-button>
    </div>
  </el-dialog>
